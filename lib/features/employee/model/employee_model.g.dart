...
const EmployeeModelSchema = CollectionSchema(
  ...
  embeddedSchemas: {
    ...
    r'GeoModel': GeoModelSchema,
    r'CompanyModel': CompanyModelSchema
  },
...
int _employeeModelEstimateSize(
  ...
  }
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          CompanyModelSchema.estimateSize(
              value, allOffsets[CompanyModel]!, allOffsets);
    }
  }
  {
...
void _employeeModelSerialize(
  ...
  writer.writeObject<CompanyModel>(
    offsets[1],
    allOffsets,
    CompanyModelSchema.serialize,
    object.company,
  );
...
EmployeeModel _employeeModelDeserialize(
  ...
  final object = EmployeeModel(
    ...
    company: reader.readObjectOrNull<CompanyModel>(
      offsets[1],
      CompanyModelSchema.deserialize,
      allOffsets,
    ),
...
P _employeeModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectOrNull<CompanyModel>(
        offset,
        CompanyModelSchema.deserialize,
        allOffsets,
      )) as P;
...
extension EmployeeModelQueryWhereSort
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterWhere> anyIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeModelQueryObject
    on QueryBuilder<EmployeeModel, EmployeeModel, QFilterCondition> {
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterFilterCondition> address(
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterFilterCondition> company(
      FilterQuery<CompanyModel> q) {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeModelQuerySortBy
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.asc);
    });
  }

  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByEmailDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.desc);
    });
  }

  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByUsername() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByWebsite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'website', Sort.asc);
    });
  }

  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> sortByWebsiteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeModelQuerySortThenBy
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.asc);
    });
  }

  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByEmailDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'email', Sort.desc);
    });
  }
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByUsername() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'username', Sort.asc);
    });
  }
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByWebsite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'website', Sort.asc);
    });
  }

  QueryBuilder<EmployeeModel, EmployeeModel, QAfterSortBy> thenByWebsiteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'website', Sort.desc);
    });
  }
...
extension EmployeeModelQueryWhereDistinct
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QDistinct> distinctByEmail(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QDistinct> distinctByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QDistinct> distinctByUsername(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, EmployeeModel, QDistinct> distinctByWebsite(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EmployeeModelQueryProperty
  ...
  QueryBuilder<EmployeeModel, AddressModel?, QQueryOperations>
      addressProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, CompanyModel?, QQueryOperations>
      companyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, String?, QQueryOperations> emailProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'email');
    });
  }

  QueryBuilder<EmployeeModel, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EmployeeModel, String?, QQueryOperations> usernameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'username');
    });
  }

  QueryBuilder<EmployeeModel, String?, QQueryOperations> websiteProperty() {
    return QueryBuilder.apply(this, (query) {
